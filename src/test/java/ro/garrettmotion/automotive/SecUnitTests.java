...
//
//        Vehicle mk1 = vehicleService.save(new Vehicle("Bugatti", "KN-5601", dateOfRegistration.plusMonths(1), temp1.getId()));
//        Vehicle mk2 = vehicleService.save(new Vehicle("Lamborghini", "GE-3710", dateOfRegistration.plusMonths(2), temp2.getId()));
//        Vehicle mk3 = vehicleService.save(new Vehicle("Peugeot", "NM-9054", dateOfRegistration.plusMonths(3), temp3.getId()));
//
...
//
//        Vehicle vehicle = vehicleService.save(new Vehicle("SPX-1122", "VL23CAP", dateOfRegistration, temp.getId()));
//
...
//        VehicleType vehicleType = vehicleTypeService.save(new VehicleType("Robots"));
//
//        Vehicle firstVehicle = vehicleService.save(new Vehicle("SPX-1122", "VL23CAP", dateOfRegistration, vehicleType.getId()));
//        Vehicle secondVehicle = vehicleService.save(new Vehicle("PSX-1122", "B999GRE", dateOfRegistration.plusMonths(5), vehicleType.getId()));
//
...
//
//
//        Vehicle mk1 = vehicleService.save(new Vehicle("Tesla", "NY-4501", dateOfRegistration, vehType1.getId()));
//        Vehicle mk2 = vehicleService.save(new Vehicle("Audi", "LA-1010", dateOfRegistration.plusMonths(2), vehType1.getId()));
//        Vehicle mk3 = vehicleService.save(new Vehicle("VW", "TX-4554", dateOfRegistration.plusMonths(3), vehType2.getId()));
//
